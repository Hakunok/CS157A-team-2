      ...
      <section className="text-center space-y-8 pb-6">
        <div className="max-w-3xl mx-auto space-y-4">
          <h1 className="text-5xl lg:text-6xl font-extrabold font-ui tracking-tight leading-tight text-foreground">
            <span className="text-[--color-primary]/90">aiRchive</span>: Elevate Your Understanding of AI
          </h1>
          <p className="text-lg lg:text-xl text-muted-foreground font-ui">
            Dive into a curated world of AI knowledge — from peer-reviewed papers to insightful blogs. Discover what’s in the future.
          </p>
        </div>
  ...
  return (
      <section className="space-y-4 pb-4">
        <h2 className="text-3xl font-semibold font-ui text-foreground">
          Welcome back, <span className="text-[--color-primary]/90">{user.firstName}</span> 👋
        </h2>
