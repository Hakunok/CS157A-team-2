  ...
  return (
      <>
        <div
            ...
            className="h-8 px-2.5 flex items-center gap-2 rounded-[var(--radius-sm)] border border-[var(--color-border)] bg-[var(--color-background)]
            text-xs text-[var(--color-muted-foreground)] hover:bg-[var(--color-muted)]/40 transition cursor-pointer"
        >
