...
import CollectionExplorePage
  from "@/pages/collectionpages/CollectionExplorePage.jsx";
...
export default function AppRoutes() {
  return (
      <Routes>
        ...
        <Route path="/my-publications" element={<PrivateRoute roles={["AUTHOR"]}>
          <MyPublicationsPage />
        </PrivateRoute>}/>
        <Route path="/my-publications/new" element={ <PrivateRoute roles={["AUTHOR"]}>
          <DraftFormPage />
        </PrivateRoute>}/>
        <Route path="/my-publications/:pubId/edit" element={ <PrivateRoute roles={["AUTHOR"]}>
          <DraftFormPage />
        </PrivateRoute>}/>
        <Route path="/my-publications/:pubId/publish" element={<PrivateRoute roles={["AUTHOR"]}>
          <PublishDraftPage />
        </PrivateRoute>}/>

        {/* collection routes */}
        <Route path="/my-collections" element={ <PrivateRoute roles={["AUTHOR", "READER"]}>
          <MyCollectionsPage />
        </PrivateRoute>}/>
        <Route path="/my-collections/new" element={ <PrivateRoute roles={["AUTHOR", "READER"]}>
          <CollectionFormPage />
        </PrivateRoute>}/>
        <Route path="/my-collections/:collectionId/edit" element={ <PrivateRoute roles={["AUTHOR", "READER"]}>
          <CollectionFormPage />
        </PrivateRoute>}/>
