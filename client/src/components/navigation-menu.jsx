...
const navigationMenuTriggerStyle = cva(
    "group inline-flex h-9 w-max items-center justify-center rounded-[var(--radius)] "
    + "px-3 py-2 text-sm font-medium font-ui transition-all duration-200 ease-in-out",
    {
      variants: {
        intent: {
          default: [
      ...
      <div className="absolute top-full left-0 isolate z-50 flex justify-center">
        <NavigationMenuPrimitive.Viewport
            ...
            className={cn(
                ...
                + "w-full md:w-[var(--radix-navigation-menu-viewport-width)] overflow-hidden",
                "rounded-[var(--radius)] border border-[var(--color-border)]/30 bg-[var(--color-popover)]/95 "
                + "text-[var(--color-popover-foreground)] backdrop-blur-sm shadow-lg",
