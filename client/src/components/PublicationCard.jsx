...
import { collectionApi } from "@/lib/api.js";
...
function PublicationCard({ publication, variant, onEdit, onPublish }) {
  ...
  if (isDraft) {
    return (
        <Tooltip.Provider>
          <div className="rounded-lg border border-[var(--color-border)] bg-[var(--color-surface)] p-5 w-full space-y-4">
                ...
                <Tooltip.Root>
                  <Tooltip.Trigger asChild>
                    <Button
                        variant="ghost"
                        size="icon"
                        className="group size-7 text-[var(--color-secondary)] hover:text-[var(--color-secondary)]"
                        onClick={(e) => {
                          e.preventDefault();
                          onEdit();
                        }}
                ...
                <Tooltip.Root>
                  <Tooltip.Trigger asChild>
                    <Button
                        variant="ghost"
                        size="icon"
                        className="group size-7 text-[var(--color-primary)] hover:text-[var(--color-primary)]"
                        onClick={(e) => {
                          e.preventDefault();
                          onPublish();
                        }}
                    >
                      <svg
                          className="size-4 stroke-current fill-none group-hover:fill-[var(--color-primary)]"
            ...
            <div className="text-sm text-muted-foreground font-ui">
              <span className="italic">Draft – not yet published</span>
            </div>
          </div>
        </Tooltip.Provider>
    );
