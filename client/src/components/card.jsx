  ...
  return (
      <div
          ...
          className={cn(
              ...
              "rounded-[var(--radius)] px-6 py-6 shadow-sm border border-[var(--color-border)] "
              + "ring-offset-background focus-visible:ring-2 focus-visible:ring-[var(--color-ring)] focus-visible:ring-offset-2",
              className
          )}
          {...props}
      />
