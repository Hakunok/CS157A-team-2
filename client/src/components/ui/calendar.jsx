  ...
  return (
      <DayPicker
          ...
          classNames={{
            ...
            dropdown_root: cn(
                "relative has-focus:border-[var(--color-ring)] border border-[var(--color-input)] shadow-xs has-focus:ring-[var(--color-ring)]/50 has-focus:ring-[3px] rounded-[var(--radius)]",
  ...
  return (
      <Button
          ...
          className={cn(
              ...
              "group-data-[focused=true]/day:ring-[3px] group-data-[focused=true]/day:ring-[var(--color-ring)]/50 group-data-[focused=true]/day:border-[var(--color-ring)]",
